{
  ...
  inputs = {
    ...
    # The locked nixpkgs package set carries kdl-hs 1.1.0. Use the current
    # upstream Hackage release so Nix and Cabal validate the same supported API.
    kdl-hs = {
      url = "https://hackage.haskell.org/package/kdl-hs-1.1.1/kdl-hs-1.1.1.tar.gz";
      flake = false;
    };
