...
title: Adopt a canonical span-preserving KDL v2 mapping
description: Adopt a canonical, span-preserving mapping from KDL v2 into Settei's core raw value tree.
